    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto justify-content-end">
          ...
          <li class="nav-item">
            <a style="color: white; font-size: 25px; margin-left: 40px;"class="nav-link" href="#">HISTORY <span class="sr-only">(current)</span></a>
          </li>
        </ul> 
      </div>
    </div>
...
<!-- Table -->
<h2 style="text-align: center; margin-top:40px; font-family: 'Roboto', cursive;">TRANSACTION HISTORY</h2>

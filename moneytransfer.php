...
<!--Table-->
<h2 style="text-align: center; margin-top:40px; font-family: 'Roboto', cursive;">MAKE A TRANSACTION</h2>
  ...
  <?php 
    ...
    ?>
        <tr style="color : black;">
            ...
            $stid=$rows['id'];
            ?>
            <td><a href="transact.php?id=<?=$stid;?>"> <button class="hero-button">Transact</button></a></td> 
        </tr>
                <?php
                    }
                ?>
